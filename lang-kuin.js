...
PR['registerLangHandler'](
    PR['createSimpleLexer'](
        [
         ...
         [PR['PR_STRING'],  /^"(?:[^"\\]|\\.)*"/, null, '"'],
         [PR['PR_STRING'],  /^'(?:[^'\\]|\\.)*'/, null, '\''],
         [PR['PR_LITERAL'], /\b2#[0-1]+(?:b(?:8|16|32|64))?\b/, null, '2'],
         [PR['PR_LITERAL'], /\b8#[0-7]+(?:b(?:8|16|32|64))?\b/, null, '8'],
         [PR['PR_LITERAL'], /\b16#[0-9A-F]+(?:b(?:8|16|32|64))?\b/, null, '1'],
        ],
        [
         ...
         [PR['PR_KEYWORD'], /^(?:end|to|me|alias)\b/, null],
